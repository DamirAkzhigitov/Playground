...
- [x] **0.1** Create `apps/compare/package.json` (`@playground/compare`)
...
- [x] **0.6** Run `pnpm install` from root, verify `pnpm --filter @playground/compare dev` starts.
...
- [x] **1A.1** Create `apps/compare/worker/` with `wrangler.toml`,
