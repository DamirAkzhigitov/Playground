# Compare App — Design System

This is the source of truth for UI decisions in `apps/compare`. Every
...
The mood board at `apps/compare/img.png` is the **visual north star** for
...
Reference implementations: `ListingsPage`, `ListingsDetailPage`
...
1. **Design at 360 px** in the browser before writing JSX. Check contrast
   and spacing against _Visual language_ and `apps/compare/img.png`.
