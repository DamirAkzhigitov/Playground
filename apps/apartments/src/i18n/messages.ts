...
const EN = {
  ...
  'questions.valuePreference': 'Compare ranking (number & date)',
  'questions.valuePreferenceHint':
    'Used on Compare for bars and overall scores: whether lower values (e.g. price, earlier date) or higher values (e.g. area, later date) rank better.',
  'questions.valueBetterLower': 'Lower / earlier is better',
  'questions.valueBetterHigher': 'Higher / later is better',
...
const RU: Record<MessageId, string> = {
  ...
  'questions.valuePreference': 'Ранжирование (число и дата)',
  'questions.valuePreferenceHint':
    'Для экрана «Сравнение»: что лучше — меньшие значения (цена, более ранняя дата) или большие (площадь, более поздняя дата).',
  'questions.valueBetterLower': 'Меньше / раньше — лучше',
  'questions.valueBetterHigher': 'Больше / позже — лучше',
...
const EL: Record<MessageId, string> = {
  ...
  'questions.valuePreference': 'Κατάταξη σύγκρισης (αριθμός & ημερομηνία)',
  'questions.valuePreferenceHint':
    'Για τη Σύγκριση: αν καλύτερα είναι μικρότερες τιμές (τιμή, νωρίτερα) ή μεγαλύτερες (εμβαδό, αργότερα).',
  'questions.valueBetterLower': 'Χαμηλότερα / νωρίτερα = καλύτερα',
  'questions.valueBetterHigher': 'Υψηλότερα / αργότερα = καλύτερα',
