...
## Week 1 — Locked _(date: ___ )_

| ID | Decision | Answer | Owner | Date |
| --- | --- | --- | --- | --- |
| D-01 | Compare positioning (public message) | _TBD_ | | |
| D-02 | First paid boundary for Compare | _TBD_ (`export` \| `premium categories` \| `saved history` \| `advanced filters`) | | |
| D-03 | v1 pricing | _TBD_ | | |
| D-04 | Billing provider | _TBD_ (`Stripe` \| `Lemon Squeezy` \| `Paddle`) | | |
